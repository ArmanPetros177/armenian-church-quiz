          ...
          <div className="max-w-2xl mx-auto px-4 py-12 text-center">
            <div className="glass-panel rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden border border-white/10">
              ...
              <p className="text-slate-300 text-sm md:text-base leading-relaxed mb-6">
                Ձեզ անհրաժեշտ կլինի ճանաչել <strong>44 Հայաստանի նշանավոր սրբավայրեր</strong>
                {' '}բարձրորակ լուսանկարների հիման վրա։ Մենք բացառել ենք փոքրամասն ու անհայտ վայրերը և
                թողել ենք միայն հայկական ճարտարապետության գոհարները:
              </p>
